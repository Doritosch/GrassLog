  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="bg-[#161B22] border border-[#30363D] rounded-2xl w-full max-w-md shadow-2xl">
        {/* 헤더 */}
        <div className="flex items-center gap-3 px-6 pt-6 pb-4 border-b border-[#30363D]">
          ...
          <div>
            <h2 className="text-white font-bold text-lg leading-tight">GrassLog에 오신 것을 환영해요</h2>
            <p className="text-[#8B949E] text-xs mt-0.5">일상을 잔디로 기록하세요</p>
          </div>
        </div>
        ...
        <div className="px-6 py-5 space-y-4">
          <div className="flex gap-3">
            ...
            <div>
              <p className="text-white text-sm font-medium">활동 기록</p>
              <p className="text-[#8B949E] text-xs mt-0.5">오늘 한 일을 텍스트, 카테고리, 이미지로 기록해요.</p>
            </div>
          </div>
          <div className="flex gap-3">
            <span className="text-xl">🌱</span>
            <div>
              <p className="text-white text-sm font-medium">잔디 그래프</p>
              <p className="text-[#8B949E] text-xs mt-0.5">GitHub처럼 연간 활동을 한눈에 확인할 수 있어요.</p>
            </div>
          </div>
          <div className="flex gap-3">
            <span className="text-xl">🏷️</span>
            <div>
              <p className="text-white text-sm font-medium">카테고리</p>
              <p className="text-[#8B949E] text-xs mt-0.5">운동, 독서, 공부 등 나만의 카테고리를 만들어 분류해요.</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 pb-6 flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer select-none">
            ...
            />
            <span className="text-[#8B949E] text-xs">다시 보지 않기</span>
          </label>
          <button
            onClick={handleClose}
            className="px-4 py-1.5 bg-[#238636] hover:bg-[#2ea043] text-white rounded-lg text-sm font-medium transition-colors"
          >
            시작하기
          </button>
        </div>
